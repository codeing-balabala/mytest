...
void test_shared_ptr(void) {
  int *a = new int{5};
  // auto value_share = std::make_shared<int>(3);
  std::shared_ptr<int> value_share{a};
  std::unique_ptr<int> value_unique;
  std::cout << "a:" << *value_share << std::endl;

  std::cout << "share ref number:" << value_share.use_count() << std::endl;
  {
    std::shared_ptr<int> value_share2 = value_share;
    std::cout << "share ref number:" << value_share.use_count() << std::endl;
  }
  {
    std::weak_ptr<int> value_share3 = value_share;
    std::cout << "share ref number:" << value_share3.use_count() << std::endl;
  }
  std::cout << "share ref number:" << value_share.use_count() << std::endl;
}
